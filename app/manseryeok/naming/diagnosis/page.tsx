            ...
            {!loading && result && (
              <>
                ...
                <NameAnalysisResultView
                  //  ⛔⛔ ★2026-09-09 — 「六 사주 명리적성」을 «안 보입니다» [대표님 지시]
                  //     「내이름정밀 분석도 해설화면 맨아래 맺음말 하단에
                  //       "6.사주명리적성"이 나오는데 ★이것은 불필요해.
                  //       그리고 ★우리 서비스가 이미 사주 서비스가 명리적성편이 있거든」
                  //
                  //   [까닭]  같은 이야기를 ★두 곳에서 합니다 —
                  //      이름 풀이 끝에 붙은 六 과, ★따로 있는 「진로적성」 서비스.
                  //      ⇒ 이름 풀이는 «이름» 이야기로 끝나야 합니다.
                  //
                  //   ⛔ 부품(NamingAptitude)을 «지우지» 않았습니다 — 끄기만 했습니다.
                  //      ⚠️ 44줄의 import 도 ⛔ 지우지 마십시오 —
                  //         검사 ⑯-f 가 그 이름이 이 화면에 있는지 봅니다.
                  //   ⚠️ 「五 이름에 담을 기운」은 ★그대로 나옵니다. 그건 이름 이야기입니다.
                  showAptitude={false}
