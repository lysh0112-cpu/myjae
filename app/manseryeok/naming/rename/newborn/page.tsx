...
const AXES = [
  //  🔴 ★2026-09-18 (10부) [대표님] — 「교재 3장」 을 뺐습니다.
  //     ⚠️ ★125칸은 «값» 이라 남깁니다. 손님이 «얼마나 꼼꼼한지» 를 아는 자리입니다.
  { icon: '🔊', title: '발음오행', desc: '성씨와 이름이 소리로 잘 흐르는지 (125칸으로 살핍니다)' },
    ...
    <main style={{
      ...
      <div style={{
        ...
        {[
          ...
          //  🔴 ★2026-09-18 (10부) [대표님] — 「교재 사전」 → 「이름 사전」
          { n: 2, t: '한글 이름 고르기', d: '사주에 맞춰 뽑은 이름 열 개 · 이름 사전 · 직접 쓰기' },
