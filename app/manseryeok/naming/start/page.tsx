...
//
//   ⚠️⚠️ 2026-08-01 «지금은 아무도 부르지 않습니다» — 지우지 마십시오.
//
//     [왜 안 쓰나]  보관함 버튼을 «둘» 로 나눴습니다 (대표님 지시).
//       [+ 새 이름 짓기]      → 바로 Step 2
//       [+ 새 이름 풀이하기]  → 바로 감정
//       → 갈림길을 «한 번 더» 거칠 이유가 없어졌습니다.
//
//     [왜 남겨 두나]  홈·배너 같은 «다른 진입점» 에서 아직 쓸 수 있습니다.
//       그때는 손님이 무엇을 원하는지 모르니 갈림길이 필요합니다.
//       ★참조 0건이라고 «지우지 마십시오». 28부에 그렇게 지웠다가
//         Vercel 배포가 20여 건 연속 실패한 적이 있습니다 (교훈 AM).
//
        ...
        {mode === 'naming' && (
          <div style={{
            ...
            <div style={{ fontSize: 10.5, color: '#a8927e', lineHeight: 1.65, marginTop: 10 }}>
              ...
              {/*  🔴 ★2026-09-18 (10부) [대표님] — 「교재」 를 뺐습니다 */}
              이름의 길흉은 성명학 기준으로 따로 살핍니다.
            </div>
          </div>
        )}
