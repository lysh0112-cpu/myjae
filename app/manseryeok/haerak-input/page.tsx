  ...
  return (
    <div style={{ minHeight: '100vh', background: BG, padding: '18px 14px 40px' }}>
      <div style={{ maxWidth: 460, margin: '0 auto' }}>
        ...
        {/*  🔴 ★2026-09-18 (10부) [대표님] — includes 의 «셋째 줄» 을 지웠습니다.
          *    [전] '교재 원문 그대로의 풀이'
          *    [까닭] ⚠️ 손님께 드리는 말이 아닙니다 —
          *      ① 「교재」 가 «무슨 책» 인지 손님은 모르십니다.
          *      ② «원문 그대로» 는 자랑이 아니라 ★「안 다듬었다」 로 읽힙니다.
          *      ③ 🔴 사실과도 다릅니다 — 손님 화면은 ★plainMap 으로 «순화해» 나갑니다.
          *         (원문 그대로 보시는 곳은 /naejeong 같은 ★연재쌤 전용 화면입니다)
          *    ⛔ 다시 넣지 마십시오. 「교재 원문 그대로」 는
          *      ★상담사 화면에서만 쓰는 말입니다.
          *
          *  ⚠️⚠️ 제가 이 주석을 ★«여는 태그 안» (속성 사이)에 넣었다가 tsc 가 멈췄습니다.
          *     JSX 는 ★<Tag … > 안쪽에 {/* … *␣/} 를 «못» 넣습니다.
          *     ⛔ 안으로 다시 옮기지 마십시오. */}
        <WalletPaySheet
          open={payOpen}
          title="하락이수 풀이"
          subtitle="해마다 바뀌는 운의 흐름을 주역의 괘로 풀어 드려요"
          includes={['상반기·하반기 두 괘', '나에게 움직이는 자리(효)']}
          item="haerak_ai"
          actionLabel="하락이수 보기"
