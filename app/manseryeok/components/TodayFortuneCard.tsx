...
export default function TodayFortuneCard() {
  ...
  /*  ⛔ ★내 띠를 «저절로» 채우지 «않습니다» [대표님 2026-09-15]
   *
   *  [왜 뺐나]  사주의 연지는 ★입춘을 기준으로 갈립니다.
   *     예) 음 1966.1.12 = 양 1966-02-02 ⇒ 입춘(2/4) «전» 이라 연주가 ★乙巳.
   *        ⇒ 사주로는 «뱀띠» 인데 손님은 평생 «범띠(1966년생)» 로 아십니다.
   *     ⇒ 저절로 골라 드리면 ★「나는 범띠인데 왜 뱀띠?」 가 됩니다.
   *  ⇒ ★손님이 «직접» 고르시게 둡니다. 오해가 없고 가장 단순합니다.
   *
   *  ⛔ 되돌려서 연지로 «저절로» 채우지 마십시오 — 검사 56 ⑩ 이 지킵니다. */
  const shownTti = ttiJi
