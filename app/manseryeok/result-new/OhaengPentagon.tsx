...
// 원 채움색 — 2026-07-19 연재쌤 지시로 진한 오행색 통일.
//   ⚠ 금(金)만 예외로 밝은 회색을 쓴다. 흰색으로 하면 아래 '흰 글씨 덧그림'과
//     겹쳐 숫자가 사라진다(채움 영역 글씨는 흰색으로 그리는 구조).
const ELEMENT_COLOR: Record<string, string> = {
  목: '#2e7d32', 화: '#c62828', 토: '#e8a317', 금: '#b8b8b8', 수: '#2b2b2b',
}
