...
// ★2026-08-01 — 색을 «여기서 정하지 않습니다». lib/saju/ohaengColor.ts 한 곳만 씁니다.
//   [왜]  이 도포표가 «기준» 인데 정작 정본 파일을 안 쓰고 자기 값을 갖고 있었습니다.
//         그 사이 화면마다 색이 갈려 여덟 벌이 되었습니다. (2026-08-01 조사)
//   ⚠ 금(金)이 밝은 회색인 까닭은 EL_CHART 주석에 옮겨 두었습니다.
import { EL_CHART, EL_TEXT } from '@/lib/saju/ohaengColor'
const ELEMENT_COLOR = EL_CHART
const LABEL_COLOR = EL_TEXT
