...
export const SAJU_TERMS: Record<string, TermInfo> = {
  ...
  문곡귀인: {
    hanja: '文曲貴人', category: '귀인',
    oneline: '감성과 예술·표현의 별',
    desc: '문창귀인과 짝을 이루는 길신이에요. 문창이 학문·논리라면, 문곡은 감성·예술이에요. 보고 듣고 느낀 것을 아름답게 표현하는 재능을 도와요.',
    good: '감수성이 풍부하고 예술적 표현이 뛰어나며, 문화·예술·연구 분야에 잘 어울려요.',
    caution: '감정에 깊이 빠지면 현실과 균형을 놓칠 수 있으니, 표현을 꾸준히 다듬어 보세요.',
  },
  금여: {
