  ...
  return (
    <div onClick={p.onClose}
      ...
      <div onClick={e => e.stopPropagation()}
        ...
        {/*  🔴🔴 ★청약철회 안내 — 2026-09-18 (10부) [대표님 확정]
          *
          *  [까닭]  ★약관 제8조 2항이 이렇게 «약속» 해 두었습니다 —
          *     「AI 콘텐츠는 결과물이 제공된 후에는 청약철회가 제한되며,
          *       회사는 이를 ★«결제 전 화면에» 표시합니다」
          *    ⇒ 그런데 화면에 ★한 줄도 없었습니다.
          *      «적어만 두고 안 지킨» 것입니다 (7부 0-1 그대로).
          *
          *  ⚠️ 이것은 손님을 겁주는 글이 아니라 ★«대표님을 지키는» 글입니다 —
          *     전자상거래법은 콘텐츠의 청약철회를 막으려면
          *     ★«미리 알렸는지» 를 봅니다. 안 알렸으면 다 보시고도 환불해 드려야 합니다.
          *
          *  ⛔ ★지우지 마십시오 — 지우시려면 «약관 제8조 2항의 그 한 마디» 도
          *     함께 빼야 합니다. 안 그러면 약관과 화면이 어긋납니다.
          *  ⚠️ ★잔액이 모자라거나(short) 오류일 때는 «안 보여 줍니다» —
          *     그때는 결제하는 화면이 아니라 «충전하러 가는» 화면입니다.
          *  ⛔ 「환불 불가」 처럼 ★센 말로 바꾸지 마십시오. 파는 물건입니다.
          *  ⇒ 검사 58 ⑦ 이 이 줄이 «살아 있는지» 를 봅니다. */}
        {state === 'ok' && !short && (
          <div style={{
            fontSize: 11, color: C.sub, lineHeight: 1.65,
            marginBottom: 10, paddingLeft: 2,
          }}>
            {/*  🔴 ★서비스 제공기간 — 2026-09-21 (10부) [대표님 확정]
              *
              *  [까닭]  토스페이먼츠 계약 메일 —
              *    「★구매자가 배송기간 또는 서비스제공기간을 인지할 수 있도록
              *      ★«상품페이지 내에» 명확히 기재되어 있어야 함」
              *  ⇒ 약관에도 화면에도 ★«한 줄도» 없었습니다 (값으로 확인).
              *    환불정책은 약관 제8조에 있지만 ★«제공기간» 은 «정말» 없었습니다.
              *
              *  ⚠️ ★전문가 상담에는 «안» 붙입니다 [대표님] —
              *     「본인이 선택한 예약일자와 시간인데 굳이 필요 있나?」
              *     ⇒ 손님이 ★달력에서 «그 날 그 시간» 을 고릅니다.
              *       「최대 며칠」 을 덧붙이면 ★오히려 헷갈립니다.
              *     ⇒ 상담 쪽은 ★계약 회신에만 적었습니다 (최대 14일 이내).
              *
              *  ⛔ 이 줄을 지우지 마십시오 — 없으면 ★카드사 심사에서 걸립니다.
              *  ⚠️ 「24시간」 은 ★넉넉히 잡은 값입니다. 실제로는 1~2분입니다.
              *     ⇒ 심사는 «최댓값» 을 봅니다. 줄이지 마십시오. */}
