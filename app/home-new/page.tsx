...
const SLIDES = [
  ...
  {
    /*  🔴 ★2026-09-15 (10부) [대표님] — 넷째 배너를 통째로 바꿨습니다.
     *    [전] tag 「커플 채팅」 · title 「연인과 함께,\nAI 조언까지」
     *         sub 「우리 사주를 아는 커플 채팅,\n명연재에서만」
     *    [까닭] 대표님 —
     *      「"커플 채팅" 태그는 완전히 삭제 · "AI" 라는 용어도 완전히 배제
     *        채팅이나 기계적인 느낌을 완전히 지우고,
     *        오랜 인연을 함께 나누는 연인과 부부」
     *    ⛔ 「채팅」 · 「AI」 를 이 칸에 다시 넣지 마십시오 (검사 57 ⑥).
     *
     *  ⚠️ ★태그는 대표님이 둘을 주셨습니다 — 「두 사람의 인연」 · 「명품 궁합」.
     *     ★앞엣것으로 넣었습니다. 「명품」 은 파는 말투에 가까워
     *     「오랜 인연」 이라 하신 결과 멀어 보였습니다.
     *     ⇒ 바꾸시려면 ★이 한 줄만 고치시면 됩니다.
     *
     *  ⚠️ ★sub 를 «두 줄» 로 끊어 두었습니다 —
     *     글자 칸이 화면의 65% (약 280px) 뿐이라 한 줄로 두면 제멋대로 접힙니다. */
    tag: '두 사람의 인연', title: '연인과 부부가 함께 보는\n깊이 있는 인연의 조화',
    sub: '두 사람이 걸어갈 길과 서로의 사주 결을\n명연재에서 정성껏 풀어냅니다.', link: '궁합 보러가기 →',
...
const SERVICES = [
  ...
  { name: EXAM_LUCK_NAME, color: '#c85a8c', bg: '#f7e6ee', href: '/manseryeok/exam-luck', cat: '기타', sub: '시험 · 일자리 · 자리', icon: '🎯', grad: ['#34d399', '#5eead4'] },
  ...
  { name: '내 이름 정밀분석', color: '#5a825a', bg: '#eaf0e6', href: '/manseryeok/naming/diagnosis-storage', cat: '개명', sub: '내 이름의 가치와 사주 밸런스 진단', icon: '📇', grad: ['#38bdf8', '#67e8f9'] },
...
export default function HomeNew() {
  ...
  return (
    <div style={{
      ...
      {/*  🔴 ★2026-09-22 (10부) [대표님] — 「골프온과 큐보드는 우선 승인 전까지
        *    숨겼다가 승인 후 추가하는 걸로 하자」
        *
        *  ⚠️ 이 줄을 누르면 ★cue.myjae.kr · golf.myjae.kr 로 «떠납니다» (같은 창).
        *     ⇒ PG 심사관이 ★심사 대상이 «아닌» 도메인을 보게 됩니다.
        *     ⇒ 그쪽은 사업자정보가 «한 곳» 뿐이고,
        *       골프온에는 ★「200원이 빠집니다」 가 «실제와 다르게» 적혀 있습니다.
        *
        *  ⛔ 못 읽으면 ★«숨김» 입니다 (HOME_FLAGS_OFF) — 켜진 채로 안 샙니다.
        *  ⛔ 심사 «중» 에 켜고 끄지 마십시오. «접수 전» 에 끄고 «통과 뒤» 에 켜십시오. */}
      {flags.sisterLinks && <SisterLinks />}
      ...
      {/* ═══════════════════════════════════════════════════════════
          ...
          ✅ 사업자등록번호·주소는 ★2026-09-08 에 «채웠습니다»
             (등록증 2026-09-04 발급 · 296-86-04182 · 법인 110111-0969044).
