    ...
    <div style={{
      ...
      <main style={{ padding: '26px 20px 60px' }}>
        <div style={{ marginBottom: '24px' }}>
          <h1 style={{ fontSize: '22px', fontWeight: 700, lineHeight: 1.4, margin: 0 }}>
            계정을 만들어주세요
          </h1>
          {/* ★2026-09-10 (밤) — 부제를 «지웠습니다» [대표님].
              [전] 「한 번 가입하면 명연재 · 큐보드 · 골프온에서 그대로 쓰입니다」
                   ⇒ ★카카오 단추 «바로 아래» 에 «같은 말» 이 또 있어 두 번 읽혔습니다.
              ⇒ 손님이 실제로 읽는 자리는 ★단추 바로 아래입니다. 그쪽을 남겼습니다.
              ⛔ 여기에 설명을 다시 넣지 마십시오 — 또 겹칩니다.
              ⚠️ 그전에는 「가입 한 번으로 내 사주를 영구 저장해요」였는데,
                 사주를 안 받게 되면서 ★사실과 달라진 자국이 있습니다. */}
        </div>
