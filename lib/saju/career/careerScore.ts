...
// ★잣대의 출전 — 교재 40쪽
//   "육친의 발달: 동일한 오행이 3개 이하(月支 포함 2개) / 25~45점"
//   "육친의 과다: 동일한 오행이 4개 이상 / 50점 이상"
//   ⚠️ 점수 배분이 100점인 까닭은 simsanOhaeng.ts 머리말을 보십시오.
//      교재 39쪽의 110점 표는 옛 판입니다. 심산 원장이 고쳐 가르치신 것이 100점입니다.
