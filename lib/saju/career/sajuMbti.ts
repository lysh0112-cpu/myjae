...
/**
 * 네 글자가 «일할 때» 어떻게 드러나는가 — 여덟 줄.
 *
 *  ★2026-08-03 (44부 29차) — buildCareerMbtiPrompt.ts 에 있던 AXIS_WORK 를
 *    ★여기로 옮겼습니다. 화면(MbtiCard)도 같은 줄을 써야 하기 때문입니다.
 *    ⚠️⚠️ 두 벌로 적으면 «다른 말을 하는 날» 이 옵니다. 여기 «한 곳» 입니다.
 *       프롬프트 쪽은 이것을 가져다 씁니다 (re-export).
 *
 ...
 * 재료 이름 → ★손님이 읽는 말 «(명리 말)»
 *
 *  ★2026-08-03 (44부 34차) — 괄호 안에 «명리 말» 을 되살렸습니다. (대표님 지시)
 *
 *  🔴 [무엇이 있었나]  28차에 「비겁·식상」 같은 말을 «전부» 걷어냈습니다.
 *     그랬더니 ★사주 화면인데 «사주가 안 보였습니다» —
 *     「주체성」이 비겁인지, 「현실 감각」이 재성인지 알 길이 없었습니다.
 *     ⚠️ 손님이 어려워하는 것과, «근거를 감추는» 것은 다릅니다.
 *
 *  ★쉬운 말이 앞, 명리 말이 괄호 안입니다. 뜻이 먼저 읽히고 근거도 보입니다.
 *  ⚠️ 이 말들이 나가는 자리는 ★「사주에서 어떻게 나온 건가요」 «안» 입니다 —
 *     근거를 보려고 여는 곳이니, 여기서는 명리 말이 나오는 것이 맞습니다.
