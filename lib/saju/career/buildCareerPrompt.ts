 ...
 *
 *   [무엇이 있었나]
 *     · 「한 번 더 볼 점」이 «맨 위» 에 있었습니다 — 경고부터 보는 셈이었습니다
 *     · 용신이 가운데 끼어 있어 «운세» 이야기가 흩어졌습니다
 *     · 강점·리더십·대운 이야기는 ★프리미엄 리포트에만 있어,
 *       그것을 끄면 통째로 사라질 자리였습니다
 *
 *   ★[이제] 다섯 단계 —
 *     1 핵심 에너지와 성향   오행 · 육친 · 일주
 *     2 강점과 행동 패턴     ★강점 지능 · ★리더십과 재물      (44부 40차 신설)
 *     3 진로와 커리어 전략   직무 · 조직 · 계열학과
 *     4 운세와 개운          용신 · ★발복 대운               (44부 40차 신설)
 *     5 종합과 한 번 더 볼 점 격과 그릇 · 신살 · 자리 · 직업 · 한 번 더 볼 점
 *
 *  ⚠️⚠️ 열쇠말(key)은 «한 글자도» 바꾸지 않았습니다 —
 *     화면(GROUPS·TABLE_AFTER)과 keyOfTitle 이 그것으로 짝을 찾습니다.
 *     ★제목도 바꾸지 않았습니다. 바꾸면 옛 기록이 카드를 못 찾습니다. (26부 교훈)
 *     ⇒ ★더한 것은 세 줄(strength·leadwealth·careerluck)과 «차례» 뿐입니다.
 */
const ORDER: Array<{ key: string; title: string; len: string }> = [
  ...
  // ── 2단계 · 강점과 행동 패턴 ── ★44부 40차 신설
  { key: 'strength',    title: '강점 지능과 행동 패턴', len: '4~5문장' },
  { key: 'leadwealth',  title: '리더십과 재물 운용',   len: '4~5문장' },
  ...
  { key: 'careerluck',  title: '발복 대운과 개운',     len: '4~5문장' },   // ★44부 40차 신설
