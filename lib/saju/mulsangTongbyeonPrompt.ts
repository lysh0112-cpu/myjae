...
- 물상을 부를 때는 그림에 실제 그려진 모습에 맞춰 자연스럽게 부르세요. 예를 들어 임수(壬)는 "바다·호수·큰 강"을 두루 뜻하지만, 그림이 잔잔한 호수나 강이면 "바다"라 우기지 말고 "넓은 물"이나 "호수", "강"처럼 그림과 어울리게 표현하세요.
