...
export const SOURCE_INDEX: SourceEntry[] = [
  ...
  { book: 'A', from: 78, to: 83, what: '합(合) — 天干合·六合·三合·方合·自化干合·暗合',
    files: ['lib/saju/hapMeaning.ts', 'lib/saju/hapJudge.ts'],
    note: '★성별을 뗌 (궁합에서 관계를 깨뜨리므로) · ' +
      '자료는 hapMeaning, **성립 판정은 hapJudge** (2026-07-29). ' +
      '78쪽 방해·쟁합·투합·합화 / 80쪽 子丑水土·巳申水金 / 83쪽 개고가 여기 있다' },
  ...
  // ★2026-07-29 등재 (34부에서 넣고 색인에 못 올린 것)
  { book: 'A', from: 139, to: 183,
    what: '4장 用神과 格 — 억부·조후·격국·통관·병약·전왕 · 10정격 · 외격',
    files: ['lib/saju/yongsinNew.ts', 'lib/saju/career/gyeokguk.ts',
            'lib/saju/career/tables/gyeokguk.ts', 'lib/saju/career/special.ts'],
    note: '★151쪽 표가 억부 5신의 출전. 157쪽이 격 정하는 법. 178쪽이 양인격. 183쪽이 외격' },
...
export const NOT_YET: Array<{ book: BookKey; pages: string; what: string; note?: string }> = [
  ...
  { book: 'A', pages: '132~138', what: '3장 끝 ~ 4장 사이 — 확인 안 함' },
  { book: 'A', pages: '184~189', what: '4장 끝(외격) ~ 이직 앞 — 확인 안 함' },
