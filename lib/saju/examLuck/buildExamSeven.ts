...
· ★재료에 있는 판정 이름(${isStudent ? '정인 · 편관 · 상관견관 · 관인상생 · 격국 · 용신 · 학마운' : '사업가 · 회사원 · 활인업 · 정인 · 편관 · 상관견관 · 관인상생 · 격국 · 용신'} …)을 그대로 쓰지 마세요. 무슨 뜻인지 생활 말로 바꿔 쓰세요. 「○○형 기질」 처럼 판정 이름에 «형» 을 붙여 쓰지도 마세요.
