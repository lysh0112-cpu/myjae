...
· 재료의 점수 · 등급 표기와 한자 간지를 그대로 옮기지 마세요. ★«천간 · 지지 · 일진 · 월운 · 세운» 같은 말도 손님 글에 쓰지 마세요 (그 달에 «무엇이 드는지» 만 말합니다). ★「전체의 15 정도」 처럼 점수 숫자를 글에 쓰지 말고, 「크지 않습니다 · 넉넉합니다」 처럼 말로 쓰세요. 다만 비율(50 : 50 · 1 : 4 : 5)은 숫자로 씁니다. «대운» 이라는 말도 쓰지 말고 «요즘 몇 해의 흐름» 처럼 쓰세요.
