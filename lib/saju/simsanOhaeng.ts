...
// ── ★★배점이 100점인 까닭 (2026-07-28 대표님 확인) ─────────────────
//   교재 39쪽 「02 寅月生과 申月生의 사주 진로 분석」에는 총 110점 표가 있다.
//       天干 時10 日10 月10 年10 / 地支 時15 日15 月30 年10 = 110
//   지금 코드는 100점이라 39쪽과 다르다. ★사고가 아니다.
//
//   심산 원장이 교재 내용을 손수 고쳐 100점으로 가르치셨고,
//   우리는 그 100점을 받아 썼다. 39쪽 표는 옛 판이다.
