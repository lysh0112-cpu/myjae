...
//
//  ★지금 담긴 것 : 十四 十二運星 (433~440)  — «한 꼭지».
//  □ 남은 것 : 十一 自然現象論 · 十二 変證論 · 十三 神殺論 · 十五 十二支神殺 · 十六 通辯要論
//     ⛔ 아래 쪽수는 «목차» 값이라 어긋납니다. ★十二運星은 목차 429 → 실제 433(+4) 였습니다.
...
export type { SomuTopic, SomuTopicSection, SomuStemBranchLine, SomuTopicOrder } from './types'
...
/** 화면에 보일 차례 — 교재 차례 그대로 */
export const SOMU_TOPIC_ORDER: string[] = ['unseong12']
