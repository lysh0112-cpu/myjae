...
//
//  ★지금 담긴 것 : 十四 十二運星(433~440) · 十五 十二支神殺(441~454)
//                   · ★十六 通辯要論(455~475)  — «세 꼭지».
//  □ 남은 것 : 十一 自然現象論 · 十二 変證論 · 十三 神殺論
//     ⛔ 목차 쪽수는 어긋납니다. ★十二運星 429→433 · 十二支神殺 437→441 · ★通辯要論 451→455
//        — ★셋 다 «+4» 였습니다.
...
import { TONGBYEON } from './tongbyeon'
...
/** 화면에 보일 차례 — 교재 차례 그대로 */
export const SOMU_TOPIC_ORDER: string[] = ['unseong12', 'sinsal12', 'tongbyeon']
